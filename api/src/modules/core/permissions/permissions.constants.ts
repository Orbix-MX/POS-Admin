...
export const ALL_PERMISSIONS: PermissionDef[] = [
  ...
  { key: 'orders:discount-override', name: 'Aplicar descuentos manuales', description: 'Permite aplicar un descuento a una línea de venta. Sin este permiso, toda línea se cobra sin descuento manual. Cada venta con descuento queda en la bitácora de auditoría.', module: 'orders', action: 'discount-override' },
  // refunds
