/**
 * storage.js
 * Capa de persistencia sobre localStorage. Si no está disponible se degrada
 * a memoria, de modo que la tienda sigue funcionando durante la sesión.
 */
window.RG = window.RG || {};
